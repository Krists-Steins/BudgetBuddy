...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		JLabel Income_Label = new JLabel("€ 999");
		...
		JLabel Food_label = new JLabel("€ 999");
		...
		JLabel Transport_label = new JLabel("€ 999");
		...
		JLabel Entertainment_label = new JLabel("€ 999");
		...
		JLabel Utilities_label = new JLabel("€ 999");
		...
		JLabel Other_label = new JLabel("€ 999");
		...
		JScrollPane transaction_scrollPane = new JScrollPane();
		...
		JLabel Income_Label_1 = new JLabel("€ 999");
		...
		JLabel Income_Label_1_1 = new JLabel("€ 999");
		...
		JLabel Income_Label_2_1 = new JLabel("€ 999");
		...
		lblNewLabel_2.setBounds(59, 0, 46, 29);
