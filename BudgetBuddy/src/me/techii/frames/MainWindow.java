...
public class MainWindow extends JFrame {
    ...
    // Masīvs vienkāršai kategoriju ID tulkošanai tekstā pēc indeksiem
    private String[] kategorijuMasivs = {"", "Income", "Food", "Transport", "Entertainment", "Utilities", "Other"};

    // GUI elementi datu attēlošanai
...
//        panel_2_1.add(lblNewLabel_1_2_1_2);
        ...
        // Šeit ir pievienota atpakaļ darbība pogai!
    ...
    public void showTransactions() throws SQLException, ClassNotFoundException {
        ...
        while (rs.next()) {
            ...
            if (type.equalsIgnoreCase("income")) {
                ...
                if (categoryId == 2) food += amount;
                else if (categoryId == 3) transport += amount;
                else if (categoryId == 4) entertainment += amount;
                else if (categoryId == 5) utilities += amount;
                else other += amount;
            }
